...
class MinimalPublisher : public rclcpp::Node
{
  public:
    ...
    {
      // Publisher publishes String messages to a topic named "ROS". 
      // The size of the queue is 10 messages.
      // publisher_ = this->create_publisher<std_msgs::msg::String>("ROS",10);
      // for custom msg test
      publisher_ = this->create_publisher<tutorial_interfaces::msg::Num>("ROS",10);
  ...
  private:
    ...
    void timer_callback()
    {
      ...
      // message.data = "Hi ROS! " + std::to_string(count_++);
